...
pub fn amm_get_token_out(sol_reserve: u64, token_reserve: u64, sol_in: u64) -> u64 {
...
pub fn amm_get_sol_out(sol_reserve: u64, token_reserve: u64, token_in: u64) -> u64 {
    if token_in == 0 || sol_reserve == 0 || token_reserve == 0 {
        return 0;
    }

    let invariant = sol_reserve as u128 * token_reserve as u128;
    let new_token_reserve = token_reserve as u128 + token_in as u128;
    let new_sol_reserve = invariant / new_token_reserve;
    let sol_out = sol_reserve as u128 - new_sol_reserve;
